...
class Helper(object):
    ...
    def telefon_camera(self,ip_address, username=None,passwd=None, protocol="rtsp", camera_name=None, fps=None, resolution=None):
        base_media_url = ""
        if protocol == "rtsp":
            base_media_url="live2.sdp"
        ...
        if username is not None:
            ...
            return "{}://{}:8080/{}".format(protocol, ip_address, base_media_url)
